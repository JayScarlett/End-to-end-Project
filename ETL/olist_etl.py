...
product_category_translation = pd.read_csv(f"{olist_path}/product_category_name_translation.csv")
...
# -----------------------------
ddl_path = os.path.join("ETL", "sql", "1_ddl_core.sql")
...
# -----------------------------
load_path = os.path.join("ETL", "sql", "2_load_core.sql")
...
# -----------------------------
analytics_views_path = os.path.join("ETL","sql", "3_analytics_views.sql")
...
# -----------------------------
star_schema_path = os.path.join("ETL","sql", "4_analytics_star_schema.sql")
...
# -----------------------------
analytics_load_path = os.path.join("ETL","sql", "5_analytics_load.sql")
