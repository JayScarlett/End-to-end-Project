...
-- If you do not have the separate translation CSV loaded into raw,
-- this will at least create category keys with NULL english names.
...
SELECT DISTINCT
    product_category_name,
    NULL::VARCHAR AS product_category_name_english
FROM raw.products
